...
public class FBARunThread3D extends Thread
{
	private FBAWorld3D world3D;			// The FBAWorld containing the cells and models of note
	 ...
	 * @param fbaModels
	 */
	public FBARunThread3D(FBAWorld3D world3D, ThreadGroup threadGroup, 
